...
const TourMapFilter: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-4 w-full">
      {/* Map Preview */}
      <div className="relative w-[280px] h-[180px] rounded-[16px] overflow-hidden cursor-pointer flex justify-center items-center bg-gray-100">
        {/* Gradient overlay */}
        <div className="absolute top-0 left-0 w-full h-full rounded-[16px] bg-gradient-to-t from-[#020E56]/20 via-[#01046C]/5 to-[#063265]/10 z-0"></div>
      ...
      {/* Full Map Section (Pushes content, not overlay) */}
      {showFullMap && (
        <div className="w-full max-w-[800px] h-[400px] rounded-[16px] overflow-hidden border border-gray-200">
          <iframe
