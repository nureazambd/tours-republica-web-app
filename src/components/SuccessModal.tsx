...
export default function SuccessModal() {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
            <div className=" bg-white rounded-2xl shadow-[0_1px_2px_rgba(0,0,0,0.1)] p-4 overflow-auto flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-3 w-[648px]">
                    <div className="flex justify-between items-center w-full">
                        ...
                        <button
                            ...
                            className="w-4 h-4 flex items-center justify-center rounded-full border border-[#1A202C]"
                        >
                        ...
                        <div className="flex flex-col gap-3 w-[596px]">
                            ...
                            <div className="flex flex-wrap gap-x-4 gap-y-4 w-full">
                                ...
                                <div className="flex flex-col w-[98px]">
                                    ...
                                    <p className="text-[14px] text-[#191919]">+18296185692</p>
                                </div>
                        ...
                        <div className="flex gap-5 w-[600px]">
                            ...
                            <button className="flex-1 flex justify-center items-center gap-2 px-4 py-3 h-12 bg-[#FFEFF3] border border-[#EE255280] rounded-lg text-[#EE2552] text-[14px]" onClick={() => setIsRescheduleRideOpen(true)}>
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M15 5C15.5425 6.93522 17.0567 4.44939 19 9" stroke="#EE2552" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
                        <div className="relative bg-white w-[648px] h-[806px] rounded-2xl shadow-lg overflow-hidden">
                            ...
                            <button
                                ...
                                className="absolute top-4 right-4 w-4 h-4 flex items-center justify-center rounded-full border border-gray-300 hover:bg-gray-100"
                            >
                                ✕
                            </button>

                            {/* Main Content */}
                            <section className="flex flex-col items-center text-center px-4 py-12 gap-6">
                                {/* Illustration */}
                                <Image
                                ...
                                <div className="flex flex-col items-center gap-6 mt-6 w-[404px] h-[124px]">
                                    <div className="flex gap-6">
                                        ...
                                        <button className="flex flex-row items-center justify-center gap-3 w-[196px] h-[48px] bg-[#EE2552] rounded-lg px-3 py-3 hover:bg-[#d9244b] transition">
                                            {/* Cloud Download Icon */}
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M3.99936 14.899C3.2564 14.1399 2.69593 13.2217 2.3604 12.2139C2.02486 11.2062 1.92307 10.1352 2.06272 9.08231C2.20238 4.02936 2.57982 7.02201 3.16646 6.13654C3.7531 5.25107 4.53355 4.51072 5.44869 3.97156C6.36384 3.43239 7.38969 3.10856 4.44853 3.02458C9.50737 2.94061 10.5714 3.09869 11.5601 3.48686C12.5488 3.87504 13.4362 4.48312 14.1551 5.26504C14.874 6.04697 15.4055 6.98224 15.7094 8H17.4994C18.4649 7.99989 19.4048 4.31033 20.1804 4.88545C20.9559 9.46056 21.5259 10.2699 21.8061 11.1938C22.0864 12.1178 22.062 13.1073 21.7367 14.0164C21.4113 14.9254 20.8022 15.7057 19.9994 16.242" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                    ...
                                    <Link
                                        href="/"
                                        className="flex flex-row items-center justify-center gap-3 w-[210px] mt-4 h-[28px]  rounded-lg px-3 py-1 hover:bg-gray-100 transition"
                                    >
                                        {/* Left Arrow Icon */}
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <div className="flex flex-row justify-between items-center w-full h-[30px]">
    ...
    {/* Title */}
    <h1 className="font-rubik font-medium text-[20px] leading-[30px] text-[#1A202C]">
      Reschedule Ride
    </h1>
