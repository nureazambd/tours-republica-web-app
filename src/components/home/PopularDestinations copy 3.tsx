                    ...
                    className={`
                      ...
                      ${
                        isAlwaysActive || isHovered
                          ? 'lg:col-span-2 scale-[0.97] shadow-2xl z-10'
                  ...
                  >
                    ...
                    <div className="relative h-[277px] overflow-hidden rounded-[16px] isolate">
                      <img
                        ...
                        className={`w-full h-full object-cover transition-transform duration-[2000ms] ease-[cubic-bezier(0.25,1,0.3,1)] ${
                      ...
                      >
                        ...
                        {/* Button */}
                        <button
                          className="flex items-center justify-center bg-[#EE2552] text-white rounded-[8px] px-[24px] py-[10px] hover:bg-[#d82047] transition-all duration-300"
                        >
                          <svg
                            width="24"
                            height="24"
