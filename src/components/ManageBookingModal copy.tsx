...
export default function ManageBookingModal() {
  const { isManageBookingOpen, closeManageBooking } = useModal();
    ...
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-50 flex items-center justify-center">
      ...
      <div className="bg-white rounded-3xl w-[576px] p-8 flex flex-col gap-8 animate-fadeIn">
        ...
        <p className="text-[#878D97] text-[14px] leading-[20px]">
          To view, print, amend, and cancel your reservation, please fill the following fields with your reservation details:
        </p>
        ...
        <div className="flex flex-col gap-6 w-full">
          ...
          <button className="bg-[#EE2552] text-white rounded-2xl py-4 flex items-center justify-center gap-4">
