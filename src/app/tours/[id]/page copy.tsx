...
// This helps Next.js to generate a proper title for the page
export const metadata: Metadata = {
  title: `${tourData.title} | Tours`,
};
  ...
  return (
    <div className="bg-white text-gray-800">
      <div className="container mx-auto px-4 py-8">
        ...
        {/* --- IMAGE GALLERY --- */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 mb-8 h-[400px]">
            ...
            <div>
             ...
             <div>
                 <img src={`https://placehold.co/400x300/55efc4/ffffff?text=Tour+Image+4`} alt={`${tourData.title} 4`} className="w-full h-full object-cover rounded-lg"/>
            </div>
             <div>
                 <img src={`https://placehold.co/400x300/fd79a8/ffffff?text=Tour+Image+5`} alt={`${tourData.title} 5`} className="w-full h-full object-cover rounded-lg"/>
            </div>
        </div>
                ...
                <div>
                    ...
                    <div className="space-y-3">
                        <div className="flex justify-between items-center">
                            <div>
                                <p>Adults</p>
                                <p className="text-sm text-gray-500">$50 / per person</p>
                            </div>
                            <div className="flex items-center gap-2">
                                <button className="w-8 h-8 rounded-full border bg-gray-100"><Minus size={16}/></button>
                                <span>1</span>
                                <button className="w-8 h-8 rounded-full border bg-gray-100"><Plus size={16}/></button>
                            </div>
                        </div>
                         <div className="flex justify-between items-center">
                            <div>
                                <p>Youths</p>
                                <p className="text-sm text-gray-500">$40 / per person</p>
                            </div>
                            <div className="flex items-center gap-2">
                                <button className="w-8 h-8 rounded-full border bg-gray-100"><Minus size={16}/></button>
                                <span>0</span>
                         ...
                         <div className="flex justify-between items-center">
                            <div>
                                <p>Children</p>
                                <p className="text-sm text-gray-500">$30 / per person</p>
                            </div>
                             <div className="flex items-center gap-2">
                                <button className="w-8 h-8 rounded-full border bg-gray-100"><Minus size={16}/></button>
                                <span>0</span>
