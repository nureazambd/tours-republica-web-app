      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-3 grid-rows-2 gap-2 mb-8 h-[450px]">
            <div className="col-span-2 row-span-2">
                <img src={`/images/tours/Santo-Domingo-City-Tour.png`} alt={tourData.title} className="w-full h-full object-cover rounded-lg"/>
            </div>
            <div className="col-span-1 row-span-1">
                 <img src={`/images/tours/Santo-Domingo-City-Tour-1.png`} alt={`${tourData.title} 2`} className="w-full h-full object-cover rounded-lg"/>
            </div>
             <div className="col-span-1 row-span-1">
                 <img src={`/images/tours/Santo-Domingo-City-Tour-2.png`} alt={`${tourData.title} 3`} className="w-full h-full object-cover rounded-lg"/>
            </div>
        </div>
