        ...
        <div className="container mx-auto px-4 lg:px-8 pt-8">
          ...
          <div className="grid lg:grid-cols-3 gap-8 mt-12">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              {/*
  Outer container for the dark header section.
  Adjust padding and width to fit your layout.
*/}
{/*
  Outer container changed to a white background (bg-white).
  Text colors inside the container are now dark (text-gray-900) for contrast.
*/}
{/* Outer container with white background.
  The styling matches the final request (white BD).
*/}
<div className="bg-white text-gray-900 p-6 pb-20"> 
  ...
  <div className="text-xs font-light text-gray-500 mb-3">
    ...
    <span className="mx-1">&gt;</span> 
    <span className="text-gray-900 font-normal">Santo Domingo City Tour</span>
  </div>

  {/* 2. Main Title */}
  <h1 className="text-[32px] lg:text-[40px] font-[500] text-gray-900 leading-tight">
    Santo Domingo City Tour
  </h1>

  {/* 3. Rating Section: 4.5 (25 Reviews) */}
  <div className="flex items-center text-sm mt-2 mb-8">
    ...
    <span className="text-blue-600 hover:text-blue-700 cursor-pointer text-sm font-normal">
        (25 Reviews)
    </span>
  </div>

  {/* 4. Information Cards (Grid Layout) */}
  <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-8 -mb-16 relative z-10">
    
    {/* Card 1: Duration - uses lucide-react 'Clock' */}
    <div className="flex flex-col items-center justify-center p-6 bg-slate-50 rounded-xl text-center shadow-md border border-gray-100">
      <Clock className="w-8 h-8 text-blue-900 opacity-80 mb-3" />
      <span className="font-semibold text-gray-800 text-lg">Duration</span>
      <span className="text-gray-600 text-sm mt-1">10 Hours</span>
    </div>

    {/* Card 2: Pickup - uses lucide-react 'MapPin' */}
    <div className="flex flex-col items-center justify-center p-6 bg-slate-50 rounded-xl text-center shadow-md border border-gray-100">
      <MapPin className="w-8 h-8 text-blue-900 opacity-80 mb-3" />
      <span className="font-semibold text-gray-800 text-lg">Pickup</span>
      <span className="text-gray-600 text-sm mt-1">At your hotel lobby</span>
    </div>

    {/* Card 3: Availability - uses lucide-react 'Calendar' */}
    <div className="flex flex-col items-center justify-center p-6 bg-slate-50 rounded-xl text-center shadow-md border border-gray-100">
      <Calendar className="w-8 h-8 text-blue-900 opacity-80 mb-3" />
      <span className="font-semibold text-gray-800 text-lg">Availability</span>
      <span className="text-gray-600 text-sm mt-1">Everyday</span>
    </div>

    {/* Card 4: Guide Language - uses lucide-react 'MessageSquare' for the chat bubble icon */}
    <div className="flex flex-col items-center justify-center p-6 bg-slate-50 rounded-xl text-center shadow-md border border-gray-100">
      <MessageSquare className="w-8 h-8 text-blue-900 opacity-80 mb-3" />
      <span className="font-semibold text-gray-800 text-lg">Guide Language</span>
      <span className="text-gray-600 text-sm mt-1">Your preferred language</span>
    </div>
  </div>
</div>
        ...
        <section className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white rounded-xl shadow-md overflow-hidden">
                    <img src="https://oaqvxfczgmjzupugrrzz.supabase.co/storage/v1/object/public/images/highlight-1.jpg" alt="3 Eyes National Park" className="w-full h-48 object-cover"/>
                    <div className="p-4">
                        <h3 className="font-semibold text-lg text-gray-900 mb-2">3 Eyes National Park</h3>
                        <p className="text-gray-600 text-sm mb-3">Explore the stunning underground caves and lagoons.</p>
                ...
                <div className="bg-white rounded-xl shadow-md overflow-hidden">
                    <img src="https://oaqvxfczgmjzupugrrzz.supabase.co/storage/v1/object/public/images/highlight-2.jpg" alt="Columbus Lighthouse" className="w-full h-48 object-cover"/>
                    <div className="p-4">
                        <h3 className="font-semibold text-lg text-gray-900 mb-2">Columbus Lighthouse</h3>
                        <p className="text-gray-600 text-sm mb-3">A monumental cross-shaped structure dedicated to Christopher Columbus.</p>
                        <button className="text-blue-600 text-sm hover:underline font-medium">
                            View map
                        </button>
                    </div>
                ...
                <div className="bg-white rounded-xl shadow-md overflow-hidden">
                    <img src="https://oaqvxfczgmjzupugrrzz.supabase.co/storage/v1/object/public/images/highlight-3.jpg" alt="Alcázar de Colón" className="w-full h-48 object-cover"/>
                    <div className="p-4">
                        <h3 className="font-semibold text-lg text-gray-900 mb-2">Alcázar de Colón</h3>
                        <p className="text-gray-600 text-sm mb-3">The first fortified palace built in the Americas, once home to Diego Columbus.</p>
                        <button className="text-blue-600 text-sm hover:underline font-medium">
                            View map
                        </button>
                    </div>
...
{/* Tour Itinerary Section */}
        <section className="mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">Tour Itinerary</h2>
            ...
            <div className="relative space-y-6">
                ...
                {/* Itinerary Item 1 */}
                <div className="flex items-start relative bg-white p-5 rounded-xl shadow-sm border border-gray-100 ml-10">
                    <div className="absolute -left-6 top-1/2 -translate-y-1/2 w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold text-sm z-10">
                        1
                    </div>
                    <div>
                        <h3 className="font-semibold text-lg text-gray-900 mb-1">7:30 AM - Morning Pickup</h3>
                        <p className="text-gray-600 text-sm">Hotel pick-ups and comfortable transfer to the Colonial Zone.</p>
                    </div>
                </div>
                ...
                <div className="flex items-start relative bg-white p-5 rounded-xl shadow-sm border border-gray-100 ml-10">
                    ...
                    <div>
                        <h3 className="font-semibold text-lg text-gray-900 mb-1">9:00 AM - Colonial Zone Tour</h3>
                        <p className="text-gray-600 text-sm">Visit to Alcazar de Colon and primative hut/colonial.</p>
                    </div>
                </div>
                ...
                <div className="flex items-start relative bg-white p-5 rounded-xl shadow-sm border border-gray-100 ml-10">
                    ...
                    <div>
                        <h3 className="font-semibold text-lg text-gray-900 mb-1">1:00 PM - Lunch Break</h3>
                        <p className="text-gray-600 text-sm">Traditional food served to flat at a local restaurant</p>
                    </div>
                </div>
                ...
                <div className="flex items-start relative bg-white p-5 rounded-xl shadow-sm border border-gray-100 ml-10">
                    ...
                    <div>
                        <h3 className="font-semibold text-lg text-gray-900 mb-1">4:30 PM - Return</h3>
                        <p className="text-gray-600 text-sm">Transfer back to your hotel</p>
                    </div>
                </div>
...
{/* More Information Header (Accordion-like) */}
        <section className="mb-12">
            <div className="bg-blue-900 p-5 rounded-xl flex items-center justify-between cursor-pointer">
                <h2 className="text-xl font-bold text-white">More Information</h2>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
                <ul className="space-y-4">
                    <li className="flex items-center">
                        <Book className="w-5 h-5 text-blue-600 mr-3 flex-shrink-0" />
                        <div>
                            <span className="font-semibold text-gray-800">When to Book</span>
                            <p className="text-gray-600 text-sm">It's recommended to book up to 24 hours before the activity.</p>
                        </div>
                    </li>
                    <li className="flex items-center">
                        <Accessibility className="w-5 h-5 text-blue-600 mr-3 flex-shrink-0" />
                        <div>
                            <span className="font-semibold text-gray-800">Accessibility</span>
                            <p className="text-gray-600 text-sm">This tour is accessible with a participating person.</p>
                        </div>
                    </li>
                    <li className="flex items-center">
                        <Leaf className="w-5 h-5 text-blue-600 mr-3 flex-shrink-0" />
                        <div>
                            <span className="font-semibold text-gray-800">Sustainability</span>
                            <p className="text-gray-600 text-sm">We adhere to responsible tourism guidelines.</p>
                        </div>
                    </li>
                    <li className="flex items-center">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 text-sm">Dominicana Tour | Our certified guides.</p>
                        </div>
                    </li>
                </ul>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
                <ul className="space-y-3">
                    <li className="flex items-start text-gray-700">
                        ...
                        <div>
                            <span className="font-semibold text-gray-800">Free cancellation up to 24 hours before tour starts.</span>
                            <p className="text-gray-600 text-sm">You can cancel free of charge up to 24 hours before the activity is scheduled. If you cancel within 24 hours, or if you don't show up, no refund will be issued.</p>
                        </div>
                    </li>
                    <li className="flex items-start text-gray-700">
                        <CheckCircle className="w-5 h-5 text-green-500 mr-2 flex-shrink-0 mt-1"/>
                        <div>
                            <span className="font-semibold text-gray-800">We offer free last-minute cancellation in the event of a medical emergency or flight cancellation.</span>
                            <p className="text-gray-600 text-sm">Proof of emergency is required. Please contact our support team to arrange.</p>
                        </div>
                    </li>
                    <li className="flex items-start text-gray-700">
                        <CheckCircle className="w-5 h-5 text-green-500 mr-2 flex-shrink-0 mt-1"/>
                        <div>
                            <span className="font-semibold text-gray-800">A 50% cancellation fee is required in case of a flight disruption.</span>
                            <p className="text-gray-600 text-sm">This is to cover the cost of pre-booked tickets and other expenses.</p>
                        </div>
                    </li>
                </ul>
            </div>
...
{/* Frequently Asked Questions Section */}
        <section className="mb-12">
            ...
            <p className="text-gray-600 text-sm mt-6 text-center">
                For more questions, <span className="text-blue-600 hover:underline cursor-pointer font-semibold">contact</span> our support team.
            </p>
        </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
                <div className="flex justify-between items-start mb-3">
                    <Quote className="w-8 h-8 text-yellow-500 fill-yellow-100 flex-shrink-0" />
                    <div className="flex text-yellow-500">
                        <Star className="w-4 h-4 fill-yellow-500" />
                        <Star className="w-4 h-4 fill-yellow-500" />
                        <Star className="w-4 h-4 fill-yellow-500" />
                ...
                <div className="flex items-center">
                    ...
                    <div>
                        <p className="font-semibold text-gray-900 text-sm">Marcus R.</p>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
                ...
                <div className="flex items-center">
                    ...
                    <div>
                        <p className="font-semibold text-gray-900 text-sm">Elena K.</p>
                        <p className="text-gray-500 text-xs">UK</p>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
                ...
                <div className="flex items-center">
                    ...
                    <div>
                        <p className="font-semibold text-gray-900 text-sm">Sophia M.</p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div className="flex flex-col items-center">
                <div className="w-16 h-16 bg-orange-100 rounded-xl flex items-center justify-center mb-4">
                    <Check className="w-8 h-8 text-orange-500 stroke-2"/>
                </div>
            ...
            <div className="flex flex-col items-center">
                <div className="w-16 h-16 bg-yellow-100 rounded-xl flex items-center justify-center mb-4">
                    <DollarSign className="w-8 h-8 text-yellow-500 stroke-2"/>
                </div>
            ...
            <div className="flex flex-col items-center">
                <div className="w-16 h-16 bg-blue-100 rounded-xl flex items-center justify-center mb-4">
                    <X className="w-8 h-8 text-blue-500 stroke-2"/>
                </div>
            ...
            <div className="flex flex-col items-center">
                <div className="w-16 h-16 bg-purple-100 rounded-xl flex items-center justify-center mb-4">
                    <Shield className="w-8 h-8 text-purple-500 stroke-2"/>
                </div>
