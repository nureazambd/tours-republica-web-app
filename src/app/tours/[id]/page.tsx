            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              <div className=" text-gray-900 px-6 pb-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-4 -mb-16 relative z-10">
                  ...
                  <div className="flex flex-col items-center justify-center p-6 bg-[#EFF2F880] rounded-xl text-center shadow">
                    <MapPin className="w-4 h-4 text-blue-900 opacity-80 mb-3" />
                  ...
                  <div className="flex flex-col items-center justify-center p-6 bg-[#EFF2F880] rounded-xl text-center shadow">
                    <Calendar className="w-4 h-4 text-blue-900 opacity-80 mb-3" />
                  ...
                  <div className="flex flex-col items-center justify-center p-6 bg-[#EFF2F880] rounded-xl text-center shadow">
                    <MessageSquare className="w-4 h-4 text-blue-900 opacity-80 mb-3" />
    ...
    Using a light gray background for the overall page content. */}
              <div className="bg-gray-50 py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-4">
                  ...
                  <section className="mb-12 bg-[#EFF2F880] p-4 rounded-2xl">
                    <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">Tour Highlights</h2>
                  ...
                  <section className="mb-12">
                    <h2 className="text-3xl font-bold text-gray-900 mb-4 text-center">Tour Itinerary</h2>
                  ...
                  <section className="mb-12 px-6">
                    ...
                    <div className="bg-[#EFF2F880] rounded-xl shadow-md border border-gray-100 divide-y divide-gray-100">
