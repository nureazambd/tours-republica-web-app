...
export default function PopularDestinations() {
  ...
  return (
    <Layout>
    <section className="bg-white flex flex-col items-center px-6 lg:px-[130px] py-[40px] lg:pt-[56px] lg:pb-[96px] gap-8 md:gap-[56px]">
      <div className="w-full max-w-[1180px] flex flex-col ">
        ...
        {/* Desktop Grid */}
        <div className="hidden md:flex flex-col gap-6 my-[40px]">
          {/* Row 1 */}
