  ...
  return (
    ...
    mb-4">
     ...
     <BookingFeaturesSection/>
      ...
      {/* BOOKING STEPS */}
      <section className="flex flex-col items-center py-[112px] px-4 lg:px-[130px] gap-[56px] bg-white text-center">
  {/* Header */}
  <div className="flex flex-col items-center gap-[8px] w-full lg:w-[1170px]">
    <h2 className="w-full lg:w-[1170px] text-[48px] leading-[56px] font-medium font-rubik text-[#191919]">
      Book now ! It's Quick and Simple
    </h2>
    <p className="w-full lg:w-[1170px] text-[16px] leading-[26px] font-normal font-rubik text-[#878D97]">
      Secure your ride in just a few easy steps — fast, hassle-free, and ready when you are.
    </p>
  </div>

  {/* Steps */}
  <div className="lg:flex flex-row flex-wrap justify-between gap-[24px] w-full lg:w-[1180px]">
    {[
      {
        title: 'Choose Route',
        description:
