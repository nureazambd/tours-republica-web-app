        ...
        Apply
            ...
            {/* <div className="flex items-center bg-[#F4F7F9] rounded-xl p-4 gap-3 w-[246px] h-[68px]">
              ...
              <div className="flex-1">
                <div className="text-[13px] text-[#878D97] leading-4">Suitcase qty</div>
                <div className="flex items-center gap-3 mt-1">
                  <button type="button" onClick={() => setSuitcases((s) => Math.max(0, s - 1))} className="w-8 h-8 rounded-md border">-</button>
                  <div className="w-8 text-center">{suitcases}</div>
